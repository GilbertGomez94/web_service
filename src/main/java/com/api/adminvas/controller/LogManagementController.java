...
public class LogManagementController {
	...
	@GetMapping(value = "readLog/{action}/{dateAction}/{Admin}/{macAddress}",
            produces = {
                    MediaType.APPLICATION_JSON_VALUE
            })
    public ResponseEntity<LogDto> ReadLog(@PathVariable String action,
        ...
        return new ResponseEntity(logMagnagement.ReadLog(log), HttpStatus.resolve(200));
    }
